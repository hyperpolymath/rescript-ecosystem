...
# Contributing — rescript-ecosystem

## Audience

Developers working **on** `rescript-ecosystem`. For consumers (people
...
``` bash
git clone git@github.com:hyperpolymath/rescript-ecosystem.git
...
- Bugs in `rescript-ecosystem`: file at
  `hyperpolymath/rescript-ecosystem/issues`.
